...
cUIObject::cUIObject() : m_vPosition(0,0,0), m_pParent(NULL), m_stSize(0,0), m_uiTag(E_UI_NONE), m_isHidden(false)
{
...
void cUIObject::Setup(D3DXVECTOR3 pos, eUIOBJECT tag)
{
	m_vPosition = pos;
